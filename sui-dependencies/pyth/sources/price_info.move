module pyth::price_info {
    ...
    #[test_only]
    public fun new_for_test(attestation_time: u64, arrival_time: u64, price_feed: PriceFeed, ctx: &mut TxContext): PriceInfoObject {
        new_price_info_object(new_price_info(attestation_time, arrival_time, price_feed), ctx)
    }
